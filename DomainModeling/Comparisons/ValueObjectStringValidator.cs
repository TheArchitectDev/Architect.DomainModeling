...
public static class ValueObjectStringValidator
{
	...
	/// </para>
	/// </summary>
	public static bool ContainsNonAlphanumericCharacters(ReadOnlySpan<char> text)
	{
	...
	/// </para>
	/// </summary>
	public static bool ContainsNonWordCharacters(ReadOnlySpan<char> text)
	{
		var remainder = text.Length;
	...
	/// </para>
	/// </summary>
	public static bool ContainsNonAsciiCharacters(ReadOnlySpan<char> text)
	{
		var remainder = text.Length;
	...
	public static bool ContainsNonAsciiOrNonPrintableCharacters(ReadOnlySpan<char> text, bool flagNewLinesAndTabs = true)
	{
	...
	/// </para>
	/// </summary>
	public static bool ContainsNonAsciiOrNonPrintableOrWhitespaceCharacters(ReadOnlySpan<char> text)
	{
		// Characters above SByte.MaxValue (127) are non-ASCII
		// ASCII char SByte.MaxValue (127) is a control character
	...
	public static bool ContainsNonPrintableCharacters(ReadOnlySpan<char> text, bool flagNewLinesAndTabs)
	{
	...
	/// </summary>
	/// <param name="flagNewLinesAndTabs">Pass true to flag \r, \n, and \t as non-printable characters. Pass false to overlook them.</param>
	public static bool ContainsNonPrintableCharactersOrDoubleQuotes(ReadOnlySpan<char> text, bool flagNewLinesAndTabs)
	{
		return flagNewLinesAndTabs
			? EvaluateIncludingNewLinesAndTabs(text)
			: EvaluateOverlookingNewLinesAndTabs(text);
	...
	/// </para>
	/// </summary>
	public static bool ContainsWhitespaceOrNonPrintableCharacters(ReadOnlySpan<char> text)
	{
